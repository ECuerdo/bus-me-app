...
export const ScheduleStats = ({ stats }: ScheduleStatsProps) => {
  return (
    <div className="grid gap-6 md:grid-cols-4">
      {stats.map((stat, i) => (
        <div key={i} className="p-6 rounded-[2rem] bg-card/40 backdrop-blur-md border border-primary/5 text-card-foreground shadow-sm flex items-center justify-between">
          <div>
