            ...
            <div className="grid gap-6 py-4">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2.5">
                  ...
                  <Input placeholder="Arterial Alpha" className="h-12 bg-muted/50 border-border focus-visible:ring-primary/30 rounded-xl font-bold text-foreground" />
                </div>
                <div className="space-y-2.5">
                  <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Distance (km)</Label>
                  <Input placeholder="246" className="h-12 bg-muted/50 border-border focus-visible:ring-primary/30 rounded-xl font-bold text-foreground" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-2.5">
                    <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Origin Node</Label>
                    <Input placeholder="Manila" className="h-12 bg-muted/50 border-border focus-visible:ring-primary/30 rounded-xl font-bold text-foreground" />
                 </div>
                 <div className="space-y-2.5">
                    <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Destination Node</Label>
                    <Input placeholder="Baguio" className="h-12 bg-muted/50 border-border focus-visible:ring-primary/30 rounded-xl font-bold text-foreground" />
                 </div>
              </div>
            </div>
