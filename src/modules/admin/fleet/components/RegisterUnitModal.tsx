          ...
          <div className="grid gap-6 py-8">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2.5">
                ...
                <Input placeholder="ABC-1234" className="h-12 bg-muted/20 border-primary/5 text-card-foreground/50 focus-visible:ring-primary/30 rounded-xl font-bold transition-all focus:bg-background" />
              </div>
              <div className="space-y-2.5">
                <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Capacity (Seats)</Label>
                <Input type="number" placeholder="45" className="h-12 bg-muted/20 border-primary/5 text-card-foreground/50 focus-visible:ring-primary/30 rounded-xl font-bold transition-all focus:bg-background" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
               <div className="space-y-2.5">
                  <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Unit Class</Label>
                  <Input placeholder="Executive" className="h-12 bg-muted/20 border-primary/5 text-card-foreground/50 focus-visible:ring-primary/30 rounded-xl font-bold transition-all focus:bg-background" />
               </div>
               <div className="space-y-2.5">
                  <Label className="text-[10px] uppercase font-black tracking-widest ml-1 text-muted-foreground">Model Name</Label>
                  <Input placeholder="Higer 2024" className="h-12 bg-muted/20 border-primary/5 text-card-foreground/50 focus-visible:ring-primary/30 rounded-xl font-bold transition-all focus:bg-background" />
               </div>
            </div>
          </div>
