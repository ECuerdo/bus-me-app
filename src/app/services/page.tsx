    ...
    <div className="relative min-h-screen flex flex-col bg-background font-sans selection:bg-primary/30 selection:text-primary-foreground overflow-x-hidden">
      ...
      <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div 
            ...
            className="absolute top-[-20%] left-[-10%] w-[60%] h-[60%] bg-emerald-500/20 blur-[150px] rounded-full" 
        />
        <motion.div 
        ...
        <motion.div 
            ...
            className="absolute top-[20%] right-[10%] w-[40%] h-[40%] bg-teal-500/10 blur-[120px] rounded-full" 
        />
