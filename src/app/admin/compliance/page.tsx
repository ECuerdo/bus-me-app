...
// ✅ Wire the module - Safety & Compliance
import ComplianceModule from "@/modules/admin/compliance/ComplianceModule";
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="/admin" className="font-bold text-muted-foreground hover:text-primary transition-colors">Admin Dashboard</BreadcrumbLink>
                                </BreadcrumbItem>
