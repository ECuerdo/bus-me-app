...
// ✅ Wire the module you asked for - Refactored to OverviewModule
import OverviewModule from "@/modules/admin/overview/OverviewModule";
...
function buildHeaderUserFromToken(token: string | null | undefined) {
    ...
    return {
        name,
        email: email || "",
        avatar: "/avatars/admin.png", // Corrected path based on previous layout
    };
}
...
export default async function Page() {
    ...
    return (
        // ✅ This fills the RIGHT column provided by SidebarInset
                        ...
                        <Breadcrumb>
                            <BreadcrumbList className="min-w-0 overflow-hidden">
                                <BreadcrumbItem className="hidden md:block shrink-0">
                                    <BreadcrumbLink href="#" className="font-bold text-muted-foreground hover:text-primary transition-colors">Admin Dashboard</BreadcrumbLink>
                                </BreadcrumbItem>
